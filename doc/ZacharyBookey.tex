...
\begin{figure}[h]
\subfloat[Simple SYMGS]{\includegraphics[width = 4.3cm]{plots/ZAB-VanillaSYMGS.png}}
\subfloat[Level Solve]{\includegraphics[width = 4.3cm]{plots/ZAB-LevelSolve.png}}
\subfloat[Inexact Solve]{\includegraphics[width = 4.3cm]{plots/ZAB-InexactSolve.png}}
