...
\lstinputlisting{plots/StandardSnippet.cpp}

Clearly we see that there is a for loop inside of our parallel kernel that doesn't update any outer values and
...
Using the above implementation of nested parallelism in our inexact solve method for symmetric gauss-seidel, we see performance results as in Figures \ref{vlength_cuda}, and \ref{vlength_openmp}, and Tables \ref{VLC} and \ref{VLO}.
