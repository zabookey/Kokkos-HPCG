...
And the goal of our project was to create a performance portable version of HPCG that gives reasonable performance on all existing supercomputers, by using Kokkos\cite{ZAB:Kokkos} library from Trilinos\cite{ZAB:Trilinos}.
...
Kokkos has two main features: \texttt{Kokkos::View} polymorphic Multidimensional  Arrays and data 
parallel execution kernels.  \texttt{Kokkos::View} is essentially a wrapper around
...
There are three main data parallel execution operations: parallel\_for,  parallel\_reduce, and parallel\_scan. 
...
\hline
 & Standard Serial SYMGS & Level Solve & Inexact Jacobi Solve \\
 \hline
